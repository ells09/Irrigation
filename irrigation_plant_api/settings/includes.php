...
function binero_check_bad_request()
{
  ...
  if(strpos($_SERVER['HTTP_USER_AGENT'], 'Googlebot') !== false && strpos(gethostbyaddr($_SERVER["REMOTE_ADDR"]),'googlebot.com') === false)
  {
    binero_block_bad_request('Detected fake Googlebot');
  }
}
